...
public class TestMturkHitGenerator {
	...
	public void retriveCvEntry() {
		...
		CvUser cvUser = mturk.loadCvUserFromTable("phani.susarla@gmail.com","12345a");
...
*/
	...
	public void testEndToEnd() {
 		...
 		envVars.put("NOTIFICATION_ENDPOINT","https://sqs.us-east-1.amazonaws.com/1234567890/crowdvision-mturk-notifications");
	...
	public void testEndToEnd2() {
 		...
 		Map<String,String> envVars = new HashMap<String,String>();
 		envVars.put("NOTIFICATION_ENDPOINT","https://sqs.us-west-2.amazonaws.com/1234567890/mturk-queue-notification");
 		mturk.setEnvironmentVariables(envVars);
